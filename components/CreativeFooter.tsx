        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/courses/container-gardens" className="text-gray-600 hover:text-primary transition-colors">Container Gardens</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/plant-library" className="text-gray-600 hover:text-primary transition-colors">Plant Library</Link></li>
              <li><Link href="/guides" className="text-gray-600 hover:text-primary transition-colors">Gardening Guides</Link></li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:hello@sproutly.com" className="text-gray-700 hover:text-primary">hello@sproutly.com</a>
                </div>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
